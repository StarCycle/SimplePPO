...
def train(env, name, target_kl, minibatch_size, gamma, ent_coef, vf_coef, num_nn, critic_std, actor_std, learning_rate, num_epoch_steps):
    ...
    for round in range(num_rounds):
        ...
        for update in range(num_update_steps):
            ...
            for start in range(0, num_env_steps, minibatch_size):
                ...
                _, newlogprob, entropy, newvalue = agent.get_action_and_value(b_obs[minds], b_actions.long()[minds])
...
if __name__ == "__main__":
    ...
    env = Grid1DEnv(grid_size, num_epoch_steps)
    env.seed(env_seed)
                            ...
                            for cstd in critic_std:
                                for astd in actor_std:
                                    for lr in learning_rate:
                                        ...
                                        train(env, name, tk, bs, ga, ef, vf, num, cstd, astd, lr, num_epoch_steps)
